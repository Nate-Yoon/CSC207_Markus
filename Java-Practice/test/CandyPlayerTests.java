...
public class CandyPlayerTests {
    static int initial;

    /* We'll talk about how junit works later, but for now, know
     * that this will be run once to do initial setup before the rest of the tests are run.
     */
    @BeforeClass
